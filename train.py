...
import random
from metrics_0310 import evaluate_codes, evaluate_hf
import numpy as np
...
def train(args):   
    ...
    for epoch_id in range(args.n_epochs):  
        ...
        model.train()
        for qids, simPatients, HF_labels, Diag_labels, main_codes, sub_codes1, sub_codes2, ages, genders, ethnics, \
            ...
            for a in range(0, bs, args.mini_batch_size):
                ...
                if args.fp16:
                    with torch.cuda.amp.autocast():
                        logits, _, (edge_idx, edge_weight), visit_att, self_att = \
